...
export default function Home() {
    ...
    const landingImages = [
        "/imagenes-creadas/postea_instagram_1779676585588.jpg",
        "/imagenes-creadas/postea_instagram_1779676597117.jpg",
        "/imagenes-creadas/postea_instagram_1779676604516.jpg",
        "/imagenes-creadas/postea_instagram_1779676613276.jpg",
        "/imagenes-creadas/postea_instagram_1779676621130.jpg",
        "/imagenes-creadas/postea_instagram_1779676629197.jpg",
        "/imagenes-creadas/postea_instagram_1779676638394.jpg",
        "/imagenes-creadas/postea_instagram_1779676645444.jpg"
    ];
            ...
            <section className="hero-section" style={{ padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center" }}>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <h1 style={{ fontSize: "clamp(38px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 32, color: "#fff" }}>
                        Crea el contenido de tu<br />
                        <span style={{ color: "#fed627" }}>marca para toda la semana</span><br />
                        <span style={{ color: "#6B7280" }}>en un solo clic</span>
                    </h1>
