        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "Inter, sans-serif", display: "flex" }}>
            ...
            <aside style={{ width: 280, borderRight: "1px solid rgba(255,255,255,0.05)", padding: "40px 24px", display: "flex", flexDirection: "column", height: "100vh", position: "fixed", background: "#050505" }}>
                ...
                <nav style={{ display: "flex", flexDirection: "column", gap: 6, flex: 1, overflowY: 'auto' }} className="custom-scrollbar">
                    ...
                    <div className={`nav-item ${activeTab === 'tutoriales' ? 'active' : ''}`} onClick={() => setActiveTab('tutoriales')}><Video size={18} /> Tutoriales</div>
                    <div className={`nav-item ${activeTab === 'configuracion' ? 'active' : ''}`} onClick={() => setActiveTab('configuracion')}><Settings size={18} /> Configuración</div>
                </nav>
                ...
                {activeTab === 'dashboard' && (
                    <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 32 }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                            {/* Banner 1: Soporte */}
                            <div style={{ padding: 24, borderRadius: 20, border: "1px solid #10B981", background: "rgba(16, 185, 129, 0.05)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, flexWrap: "wrap" }}>
                                <div style={{ flex: 1, minWidth: 300 }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#10B981", fontWeight: 900, fontSize: 18, marginBottom: 8 }}>
                                        <MessageSquare size={20} /> Soporte directo incluido
                                    </div>
                                ...
                                <a href="https://wa.link/6y79xi" target="_blank" rel="noopener noreferrer" style={{ background: "#10B981", color: "#000", padding: "12px 24px", borderRadius: 12, fontWeight: 800, fontSize: 14, textDecoration: "none", whiteSpace: "nowrap" }}>
                                    Escribir a WhatsApp
                                </a>
                            </div>

                            {/* Banner 2: Atencion */}
                            <div style={{ padding: 24, borderRadius: 20, border: "1px solid #8B5CF6", background: "rgba(139, 92, 246, 0.05)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, flexWrap: "wrap" }}>
                                <div style={{ flex: 1, minWidth: 300 }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#8B5CF6", fontWeight: 900, fontSize: 18, marginBottom: 8 }}>
                                        <Users size={20} /> ¡ATENCIÓN MUY IMPORTANTE!
                                    </div>
                                    <p style={{ color: "#9CA3AF", fontSize: 14, margin: 0, lineHeight: 1.5 }}>
                                        Es increíble e indispensable que ingreses a la comunidad de Postea. Hay un grupo de emprendedores gigantes compartiendo valor y resultados. ¡No te quedes por fuera!
                                    </p>
                                </div>
                                <a href="https://chat.whatsapp.com/JjcxClSZepXKHmUwZUuXpS" target="_blank" rel="noopener noreferrer" style={{ background: "#8B5CF6", color: "#fff", padding: "12px 24px", borderRadius: 12, fontWeight: 800, fontSize: 14, textDecoration: "none", whiteSpace: "nowrap" }}>
                                    Acceder al Grupo
                                </a>
                            </div>
                        </div>
...
{/* NEW INSTAGRAM POSTS */}
                ...
                {activeTab === 'tutoriales' && (
                    <div className="tab-content fade-in" style={{ padding: "40px 0" }}>
                        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 24px" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 40 }}>
                                <div style={{ width: 64, height: 64, background: "rgba(254, 214, 39,0.1)", borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    <Video size={32} style={{ color: "#fed627" }} />
                                </div>
                                <div>
                                    <h1 style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-0.02em", margin: "0 0 8px 0" }}>Tutoriales</h1>
                                    <p style={{ color: "#9CA3AF", fontSize: 16, margin: 0 }}>Aprende a usar la plataforma paso a paso</p>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 32 }}>
                                ...
                                <div className="glass-card" style={{ padding: 24, borderRadius: 24 }}>
                                    <h3 style={{ fontSize: 18, fontWeight: 800, marginBottom: 16 }}>Cómo instalar API Key #1</h3>
                                ...
                                {/* Video 2 */}
                                <div className="glass-card" style={{ padding: 24, borderRadius: 24 }}>
                                    <h3 style={{ fontSize: 18, fontWeight: 800, marginBottom: 16 }}>Cómo instalar API Key #2</h3>
                                    <div style={{ position: "relative", paddingBottom: "56.25%", height: 0, borderRadius: 16, overflow: "hidden" }}>
                                        <iframe 
                ...
                {activeTab === 'configuracion' && (
                    <div className="tab-content fade-in" style={{ padding: "40px 0" }}>
                        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 40 }}>
                                <div style={{ width: 64, height: 64, background: "rgba(254, 214, 39,0.1)", borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    <Settings size={32} style={{ color: "#fed627" }} />
                                </div>
                                <div>
                                    <h1 style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-0.02em", margin: "0 0 8px 0" }}>Configuración</h1>
                                    <p style={{ color: "#9CA3AF", fontSize: 16, margin: 0 }}>Actualiza tus datos personales y foto de perfil</p>
                                </div>
                            </div>
                            ...
                            <div className="glass-card" style={{ padding: 32, borderRadius: 24 }}>
                                <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                    ...
                                    {/* Foto de Perfil */}
                                    <div>
                                        <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#9CA3AF", marginBottom: 12, textTransform: "uppercase", letterSpacing: "0.05em" }}>Foto de Perfil</label>
                                        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                                            <div style={{ position: "relative", width: 80, height: 80, borderRadius: 20, overflow: "hidden", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
                                                <img src={getAvatarUrl()} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                            </div>
                                            <div>
                                                <input 
                                                    type="file" 
                                                    id="photo-upload-config"
                                                    accept="image/*" 
                                                    onChange={handlePhotoUpload} 
                                                    style={{ display: "none" }} 
                                                />
                                                <label 
                                                    htmlFor="photo-upload-config" 
                                                    className="btn-primary" 
                                                    style={{ padding: "10px 20px", fontSize: 13, cursor: "pointer", display: "inline-block" }}
                                                >
                                                    Subir nueva foto
                                                </label>
                                                <p style={{ color: "#6B7280", fontSize: 12, marginTop: 8, margin: "8px 0 0 0" }}>Formatos recomendados: JPG, PNG o GIF.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Datos Personales */}
                                    <div>
                                        <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#9CA3AF", marginBottom: 8, textTransform: "uppercase", letterSpacing: "0.05em" }}>Nombre Completo</label>
                                        <input 
                                            className="input-field" 
                                            value={user?.name || ""} 
                                    ...
                                    <div>
                                        <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#9CA3AF", marginBottom: 8, textTransform: "uppercase", letterSpacing: "0.05em" }}>Correo Electrónico</label>
                                        <input 
                                            className="input-field" 
                                            value={user?.email || ""} 
                                            disabled
                                            style={{ width: "100%", maxWidth: 400, opacity: 0.5, cursor: "not-allowed", background: "rgba(255,255,255,0.02)" }}
                                        />
                                        <p style={{ color: "#6B7280", fontSize: 12, margin: "8px 0 0 0" }}>El correo electrónico no se puede modificar.</p>
                                    </div>
                                    ...
                                    <button 
                                        ...
                                        onClick={async () => {
                                            if (user) {
                                                localStorage.setItem("clickads_user", JSON.stringify(user));
                                                try {
                                                ...
                                                setToast({ msg: "Perfil guardado correctamente", type: "success" });
                                            }
                                        }}
                                        style={{ padding: "16px 32px", fontSize: 14, alignSelf: "flex-start", marginTop: 8 }}
                                    >
                                        Guardar Cambios
                                    </button>
                                </div>
